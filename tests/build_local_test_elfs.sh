...
echo "**Building app-apwine for Nano S..."
make clean BOLOS_SDK=$NANOS_SDK
make -j DEBUG=10 BOLOS_SDK=$NANOS_SDK
cp bin/app.elf "tests/elfs/apwine_nanos.elf"

echo "**Building app-ethereum for Nano S..."
cd $APP_ETHEREUM
make clean BOLOS_SDK=$NANOS_SDK
make -j DEBUG=10 BOLOS_SDK=$NANOS_SDK CHAIN=ethereum BYPASS_SIGNATURES=1 ALLOW_DATA=1
cd -
...
echo "**Building app-apwine for Nano X..."
make clean BOLOS_SDK=$NANOX_SDK
make -j DEBUG=1 BOLOS_SDK=$NANOX_SDK
cp bin/app.elf "tests/elfs/apwine_nanox.elf"
